...
CREATE TABLE `draws` (
  ...
  `lotteries_id` bigint unsigned NOT NULL,
  `draw_date` timestamp NOT NULL,
  `won_number` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `draws_lotteries_id_foreign` (`lotteries_id`),
  CONSTRAINT `draws_lotteries_id_foreign` FOREIGN KEY (`lotteries_id`) REFERENCES `lotteries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `tickets` (
  ...
  PRIMARY KEY (`id`),
  KEY `tickets_draw_id_foreign` (`draw_id`),
  CONSTRAINT `tickets_draw_id_foreign` FOREIGN KEY (`draw_id`) REFERENCES `draws` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-02-14 11:33:20
